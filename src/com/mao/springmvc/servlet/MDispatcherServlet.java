...
import com.mao.springmvc.ioc.context.ApplicationContext;
...
//        doAutowired();
    ...
    private void initHandlerMapping() throws Exception {
        //如果 applicationContext中的beanDefinition 长度为 0 return
        if(applicationContext.getBeanDefinitionCount() == 0) return;
        //applicationContext 中获取 Bean
...
//                    未标有 @MRequestMapping的方法跳过
                    ...
                    //存放在 handlerMapping中
                    handlerMapping.add(new Handler(applicationContext.getBean(beanName),method,pattern));
                }
            }else {
                continue;
            }
